...
public class RecepiesHandler {
    public static void initRecipes() {
        ...
        CANNER_RECIPES.recipeBuilder().duration(600).EUt(480)
                ...
                .outputs(new ItemStack(Items.URANIUM_ROD))
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(120)
                .input(Items.URANIUM_ROD, 2)
                .fluidInputs(SolderingAlloy.getFluid(144))
                .outputs(new ItemStack(Items.URANIUM_ROD_DUAL))
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(120)
                .input(Items.URANIUM_ROD_DUAL, 2)
                .fluidInputs(SolderingAlloy.getFluid(144))
                .outputs(new ItemStack(Items.URANIUM_ROD_QUAD))
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.URANIUM_ROD_DEP).getItem())
                ...
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.URANIUM_ROD_DUAL_DEP).getItem())
                ...
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.URANIUM_ROD_QUAD_DEP).getItem())
        ...
        CANNER_RECIPES.recipeBuilder().duration(600).EUt(480)
                ...
                .outputs(new ItemStack(Items.MOX_ROD))
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(120)
                .input(Items.MOX_ROD, 2)
                .fluidInputs(SolderingAlloy.getFluid(144))
                .outputs(new ItemStack(Items.MOX_ROD_DUAL))
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(120)
                .input(Items.MOX_ROD_DUAL, 2)
                .fluidInputs(SolderingAlloy.getFluid(144))
                .outputs(new ItemStack(Items.MOX_ROD_QUAD))
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.MOX_ROD_DEP).getItem())
                .outputs(OreDictUnifier.get(dust, Uranium238, 3))
                ...
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.MOX_ROD_DUAL_DEP).getItem())
                .outputs(OreDictUnifier.get(dust, Uranium238, 6))
                ...
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.MOX_ROD_QUAD_DEP).getItem())
                .outputs(OreDictUnifier.get(dust, Uranium238, 12))
        ...
        COMPRESSOR_RECIPES.recipeBuilder().duration(600).EUt(480)
                ...
                .outputs(new ItemStack(Items.ENRICHED_THORIUM_FUEL))
                .buildAndRegister();
        CANNER_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(GTIUtil.getIC2ItemStack(ItemName.crafting, CraftingItemType.fuel_rod, 1).getItem(), 1, 9)
                .input(Items.ENRICHED_THORIUM_FUEL)
                .outputs(new ItemStack(Items.THORIUM_ROD))
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(120)
                .input(Items.THORIUM_ROD, 2)
                .fluidInputs(SolderingAlloy.getFluid(144))
                .outputs(new ItemStack(Items.THORIUM_ROD_DUAL))
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(120)
                .input(Items.THORIUM_ROD_DUAL, 2)
                .fluidInputs(SolderingAlloy.getFluid(144))
                .outputs(new ItemStack(Items.THORIUM_ROD_QUAD))
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.THORIUM_ROD_DEP).getItem())
                ...
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.THORIUM_ROD_DUAL_DEP).getItem())
                ...
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.THORIUM_ROD_QUAD_DEP).getItem())
        ...
        COMPRESSOR_RECIPES.recipeBuilder().duration(600).EUt(480)
                ...
                .outputs(new ItemStack(Items.NAQUADAH_FUEL))
                .buildAndRegister();
        CANNER_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(GTIUtil.getIC2ItemStack(ItemName.crafting, CraftingItemType.fuel_rod, 1).getItem(), 1, 9)
                .input(Items.NAQUADAH_FUEL)
                .outputs(new ItemStack(Items.NAQUADAH_ROD))
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(120)
                .input(Items.NAQUADAH_ROD, 2)
                .fluidInputs(SolderingAlloy.getFluid(144))
                .outputs(new ItemStack(Items.NAQUADAH_ROD_DUAL))
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(120)
                .input(Items.NAQUADAH_ROD_DUAL, 2)
                .fluidInputs(SolderingAlloy.getFluid(144))
                .outputs(new ItemStack(Items.NAQUADAH_ROD_QUAD))
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.NAQUADAH_ROD_DEP).getItem())
                ...
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.NAQUADAH_ROD_DUAL_DEP).getItem())
                ...
                .buildAndRegister();
        CENTRIFUGE_RECIPES.recipeBuilder().duration(600).EUt(480)
                .input(new ItemStack(Items.NAQUADAH_ROD_QUAD_DEP).getItem())
